...
public class DashboardService {
    ...
    private List<Map<String, Object>> getListOfMapsForChart3() {
        ...
        map2.put("data", Arrays.asList(
                ...
                Arrays.asList( 1564617600000L, 87),
                Arrays.asList( 1567296000000L, 90),
                Arrays.asList( 1569891600000L, 88),
                Arrays.asList( 1572570000000L, 85),
                Arrays.asList( 1575162000000L, 86),
                Arrays.asList( 1577840400000L,  85),
